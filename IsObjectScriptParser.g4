...
expression:
    unary_expression
    | primary_expression
    | primary_expression (P_UNDESCORE expression)+;
...
unary_expression:
	P_MINUS_SIGN primary_expression
	| P_PLUS_SIGN primary_expression;
...
f_listget: F_LISTGET OPEN_PARENTHESIS expression (P_COMMA expression)? CLOSE_PARENTHESIS;
